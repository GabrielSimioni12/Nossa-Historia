...
export const storySlides: StorySlide[] = [
  ...
  { id: 11, photo: '/photos_OF/11.png', caption: 'Escreva aqui a legenda desse momento', duration: 70, music: { title: 'i love you im sorry', artist: 'Artista', src: '/music/story-11.mp3' } },
  { id: 12, photo: '/photos_OF/12.png', caption: 'Escreva aqui a legenda desse momento', duration: 70, music: { title: 'Too sweet', artist: 'Artista', src: '/music/story-12.mp3' } },
  { id: 13, photo: '/photos_OF/13.png', caption: 'Escreva aqui a legenda desse momento', duration: 70, music: { title: 'End of Begging', artist: 'Artista', src: '/music/story-4.mp3' } },
  { id: 14, photo: '/photos_OF/14.jpeg', caption: 'Escreva aqui a legenda desse momento', duration: 70, music: { title: 'Wildest Dreamns', artist: 'Artista', src: '/music/story-14.mp3' } },
  { id: 15, photo: '/photos_OF/15.mp4', caption: 'Escreva aqui a legenda desse momento', duration: 70, music: { title: 'Ultima dança', artist: 'Artista', src: '/music/story-15.mp3' } },
